...
public interface Shorts {
	...
	/**
	 * Checks the validity of a given short ID.
	 * 
	 * @param shortId The ID of the short to be checked.
	 * @return (OK) if the short ID is valid;<br>
	 *         NOT_FOUND if the short ID does not exist.
	 */
